    ...
    <div className='mt-20 mb-32'>
      ...
      <div className='space-y-3'>
        <div>
          ...
          <p className='text-sm text-zinc-400 mt-0.5'>Design system and full visual redesign</p>
        </div>
        <div>
          <div className='flex justify-between items-baseline'>
          ...
          <p className='text-sm text-zinc-400 mt-0.5'>105k MAUs after the relaunch</p>
        </div>
        <div>
          <div className='flex justify-between items-baseline'>
        ...
        <div>
          <div className='flex justify-between items-baseline'>
            <span className='font-medium'>NeN</span>
            <span className='text-zinc-400 text-sm ml-4'>Design Systems</span>
          </div>
          <p className='text-sm text-zinc-400 mt-0.5'>Rebuilt the design system foundations</p>
        </div>
        <div>
          <div className='flex justify-between items-baseline'>
      ...
      <div className='space-y-4'>
        <div>
          <div className='flex justify-between items-baseline'>
            ...
            <span className='text-zinc-400 text-sm tabular-nums ml-4 shrink-0'>2023–</span>
          </div>
