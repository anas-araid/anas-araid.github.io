...
const Bio = (): JSX.Element => {
  ...
  return (
    <div className='mt-20'>
      ...
      <p className='text-base mt-2 font-normal'>Lately I'm interested in design systems, motion and the feel of things. The kind of work you only notice when it's missing.</p>
