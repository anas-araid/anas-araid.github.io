...
const KBarButton: FunctionComponent<TKBarButtonType> = ({ className, isDarkMode, onClick, ...rest }) => (
  <button
    onClick={onClick}
    className={concatClassNames(className || '', 'flex align-middle rounded-md bg-transparent w-6 h-6 border-0 cursor-pointer outline-none')}
    {...rest}
  >
    <svg height='24' viewBox='0 0 20 20' fill={isDarkMode ? '#FFFFFF' : '#000000'}>
